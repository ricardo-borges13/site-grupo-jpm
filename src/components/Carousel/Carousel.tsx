...
import bannerEletrica from '../../assets/images/Banner-Eletrica.jpg'
    ...
    <Carousel interval={8000} fade>
      ...
      { /* --- SLIDE 2 COM VÍDEO --- */}
        ...
        <Carousel.Caption>
          ...
          <h4>Há mais de 25 anos fornecendo soluções completas em materiais elétricos e borrachas industriais.</h4>
          </S.Caption1>
        </Carousel.Caption>
      </Carousel.Item >
