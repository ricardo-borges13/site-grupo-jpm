...
export const Automacao = () => {
  return (
    <PageSection title="AUTOMAÇÃO" image={image}>
      <S.Container>
        <header>
          ...
          <p>
            ...
            conectamos materiais elétricos, componentes em borracha / plástico e
            automação industrial. Com sede em
            <strong> Belo Horizonte (MG)</strong>, estamos comprometidos com a
            inovação, a qualidade no atendimento e o desenvolvimento dos nossos
            times.
          </p>
        </header>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              ...
              industrial, processos automatizados e fornecimento de componentes
              elétricos e de borracha, proporcionando desafios e oportunidades
              de crescimento.
            </li>
            <li>
              <strong>Cultura de equipe:</strong> valorizamos o trabalho
              colaborativo, o respeito pelas pessoas e a construção contínua de
              conhecimento. Cada colaborador faz a diferença.
            </li>
            <li>
              <strong>Localização estratégica:</strong> nossa sede está em Belo
              Horizonte (MG), no bairro Camargos — de fácil acesso para quem
              reside ou deseja atuar na região.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            Após a análise e havendo uma vaga disponível, entraremos em contato
        ...
        <section>
          ...
          <p>
            ...
            desenvolvimento profissional é estimulado, o trabalho tem impacto e
            cada conquista é valorizada. Queremos que você cresça junto com a
            gente.
          </p>
        </section>
      </S.Container>
