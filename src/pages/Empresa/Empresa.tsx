        ...
        <S.Container>
          <header>
            ...
            <p>
              ...
              <strong> JPM Borrachas e Materiais Elétricos</strong> é
              especializada na
              <strong> revenda de insumos industriais</strong>, atendendo
              empresas de diversos segmentos com soluções em{' '}
              <strong>materiais elétricos</strong>,
              <strong> borrachas industriais</strong>,{' '}
              <strong>automação</strong> e<strong> manutenção</strong>. Com sede
              em
              <strong> Belo Horizonte (MG)</strong>, atua em todo o território
              nacional, oferecendo atendimento técnico e logístico ágil, com
              foco na eficiência e na confiabilidade das operações de seus
              clientes.
            </p>
          </header>
          ...
          <section>
            ...
            <ul>
              <li>
                <strong>Materiais Elétricos:</strong> iluminação, cabos, painéis
                de comando, conexões e dispositivos industriais.
              </li>
              <li>
              ...
              <li>
                <strong>Automação Industrial:</strong> IHMs, PLCs, inversores,
                fontes, módulos de interface e CPUs.
              </li>
              <li>
                <strong>Acessórios de Manutenção:</strong> produtos para
                vedação, rodas, rodízios e componentes de suporte industrial.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul>
              <li>
                Fornecer <strong>soluções industriais completas</strong> que
                combinem estoque amplo, atendimento personalizado e agilidade
                logística.
              </li>
              <li>
                Garantir a <strong>máxima eficiência operacional</strong> e a
                <strong> confiabilidade</strong> nas operações de nossos
                clientes.
              </li>
              <li>
          ...
          <section>
            ...
            <dl>
              ...
              <dt>Endereço</dt>
              <dd>
                Rua Soares Nogueira, nº 10 – Bairro Camargos, Belo Horizonte,
                Minas Gerais
              </dd>
